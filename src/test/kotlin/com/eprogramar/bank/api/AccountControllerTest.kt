...
class AccountControllerTest {
    ...
    @Test
    fun `test find all`() {
        accountRepository.save(Account(name = "Test", document = "12345678910", phone = "987654321"));
    ...
    @Test
    fun `test find by id`() {
        val account = accountRepository.save(Account(name = "Test", document = "12345678910", phone = "987654321"));
